return {
    ...
    -- go stuff plugin
    {
        ...
        event  = "BufReadPre *.go",    -- or use ft if you prefer
        run    = ":GoInstallBinaries", -- install/update go tools
        config = function()
            -- basic vim-go settings
            vim.g.go_fmt_command      = "goimports"
            vim.g.go_def_mapping      = false -- example: disable default <Leader>gd
            vim.g.go_doc_popup_window = false
            -- you can add more vim-go g: settings here
        end,
    },
